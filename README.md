...
| `AUTH_TYPE` | `none` | options: none, static, jwt, oauth-proxy, oidc-proxy, remote-oauth |
...
| `DEBUG` | `False` |  |
| `PYTHONUNBUFFERED` | `1` |  |
| `OSF_TOKEN` | secret-injected | OSF / PsyArXiv |
| `S2_API_KEY` | secret-injected | Semantic Scholar |
| `NCBI_API_KEY` | secret-injected | PubMed Central (NCBI E-utilities) |
| `SEARCHTOOL` | `True` |  |
| `DISCOVERYTOOL` | `True` |  |
| `STORAGETOOL` | `True` |  |
...
_21 package + 14 inherited variable(s). Auto-generated from `.env.example` + the shared agent-utilities set — do not edit._
<!-- ENV-VARS-TABLE:END -->
