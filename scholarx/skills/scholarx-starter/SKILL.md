---
name: scholarx-starter
description: >-
  Scholarx API + MCP Server + A2A Server Use when working with Scholarx via this package's MCP
...
license: MIT
tags: [scholarx-starter, starter, mcp]
metadata:
  author: Genius
  version: '0.1.0'
---

# Scholarx Starter Skill

Starter skill for the **Scholarx** package. Use the `mcp-client` universal skill
