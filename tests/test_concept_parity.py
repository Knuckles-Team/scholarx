...
# Paths
ROOT_DIR = "/home/apps/workspace/agent-packages/agents/scholarx"
...
def test_concept_parity():
    """
    Enforces that all concepts documented or used in scholarx
    ...
    assert not unregistered_concepts, (
        f"The following concepts are used in scholarx but are NOT registered "
